  ...
  return (
    <section className="relative min-h-[85vh] flex items-center overflow-hidden pt-[72px]">
      ...
      <div className="container relative z-10">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-[#2a2a2a] bg-[#111] font-mono text-xs text-[#a09a95] mb-6">
          <span className="w-2 h-2 rounded-full bg-[#22c55e] animate-pulse" />
          Now Open in Jeffrey&apos;s Bay
        </div>
        <h1 className="text-[clamp(3rem,8vw,6rem)] leading-none mb-4 max-w-[680px]">
          STORE SAFE. <span className="text-[#D4006A]">STORE SMART.</span>
        </h1>
        <p className="text-lg text-[#a09a95] leading-relaxed max-w-[540px] mb-8">

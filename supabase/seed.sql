...
INSERT INTO units (name, size, sqm, dimensions, price_monthly, price_annual, availability, description, features, image_url) VALUES
-- Extra Small Units (6 sqm)
('Locker XS-01', 'extra-small', 6, '3m × 2m × 2.4m', 450, 4860, 'available', 
...
('Locker XS-02', 'extra-small', 6, '3m × 2m × 2.4m', 450, 4860, 'available',
 'Compact storage solution for seasonal items, sports equipment, or business archives.',
 ARRAY['24/7 Access', 'CCTV Monitored', 'Individual Lock', 'Ground Floor'],
 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=400&h=300&fit=crop'),

-- Small Units (9 sqm)
('Unit S-01', 'small', 9, '3m × 3m × 2.4m', 750, 8100, 'available',
...
('Unit S-02', 'small', 9, '3m × 3m × 2.4m', 750, 8100, 'few-left',
...
-- Medium Units (18 sqm)
('Unit M-01', 'medium', 18, '6m × 3m × 2.4m', 1200, 12960, 'available',
...
('Unit M-02', 'medium', 18, '6m × 3m × 2.4m', 1200, 12960, 'available',
 'Ideal for renovation storage, business stock, or household contents during a move.',
 ARRAY['24/7 Access', 'CCTV Monitored', 'Roll-up Door', 'Drive-up Access', 'Well-lit'],
 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=400&h=300&fit=crop'),

-- Large Units (27 sqm)
('Unit L-01', 'large', 27, '9m × 3m × 2.4m', 1800, 19440, 'available',
...
('Unit L-02', 'large', 27, '9m × 3m × 2.4m', 1800, 19440, 'few-left',

  ...
  return (
    <>
      <section className="page">
        <div className="container" style={{ maxWidth: 800 }}>
          <div className="text-center mb-10">
            <h1 className="page__title text-5xl">About Us</h1>
      ...
      <section className="section section--sm section--alt">
        <div className="container">
          <div className="section__header">
            <h3 className="text-3xl">Security Features</h3>
            ...
            {securityFeatures.map((f, i) => (
              <div key={i} className="card card--static rounded-md">
                <div className="card__body text-center">
                  <div className="flex justify-center mb-4"><f.icon className="w-12 h-12 text-[#D4006A]" /></div>
      ...
      <section className="section section--sm">
        <div className="container">
          <div className="section__header">
            <h3 className="text-3xl">Why Jeffrey&apos;s Bay?</h3>
